...
/*Arrays for Choices*/
const choiceTexts = [
/*0*/ [{text: "Ask the fishermen.", nextStep: 0, condition:{strength: 6} }, { text: "Approach the shady figure.", nextStep: 1, condition: {strength: 5}}, { text: "Talk to the merchants.", nextStep: 2 }],
...
/*11*/[{text: "Force the barkeeper to give you the desired Information", nextStep: 28, strength: 1}, {text: "Tell the barkeeper who you are and demand the Information",}, {text: "Offer the whole tavern a free drink for information."}],
/*12*/[{text: "Restart", nextStep: 25}, {text: "Restart", nextStep: 25}, {text: "Restart", nextStep: 25}],
/*13*/[{text: "Decide to face them head on, and force them to give you more informations.",condition: {strength: 8}}, {text: "try to bribe them to give you the informations.",intelligence: 2}, {text:"follow them once they leave the tavern.", dexterity: 2}],
];
